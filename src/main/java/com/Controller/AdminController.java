...
public class AdminController {
	...
	public PlayCard AddGame(@RequestBody PlayCard game) throws PlayCardException {
	...
	public PlayCard DeletePlaycard(@PathVariable("gid") int gid) throws PlayCardException {
		return playCardService.DeletePlaycard(gid);
	}
	
	@PatchMapping(value = "UpdatePlaycard")
	public PlayCard UpdateGame(@RequestBody PlayCard game) throws PlayCardException {
	...
	public Game DeleteGame(@PathVariable("gid") int gid) throws GameException {
		return gameservice.DeleteGame(gid);
	}
	
	@PutMapping(value = "AddGameTocard/{pcid}/{gid}")
	public PlayCard AddGameTocard(@PathVariable("pcid") int pcid, @PathVariable("gid") int gid) throws GameException {
